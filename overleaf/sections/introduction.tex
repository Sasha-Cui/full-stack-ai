...
\section{Introduction}
  ...
  \paragraph{Organization}
    This tutorial is organized into modules covering the full AI development pipeline:
    \begin{itemize}
      \item \textbf{Foundations}: PyTorch, JAX, and TensorFlow fundamentals
      \item \textbf{LLMs as Black Boxes}: Inference, evaluation, deployment, and serving
      \item \textbf{Post-Training}: Supervised fine-tuning (SFT) and reinforcement learning (RL)
      \item \textbf{Agentic Systems}: Software and hardware agents, multi-step reasoning
      \item \textbf{Systems}: Distributed training (Ray), efficient serving (vLLM), memory optimization (DeepSpeed)
    \end{itemize}
    Each module includes minimal working examples (MWEs), detailed explanations, and practical exercises.

  \paragraph{Acknowledgements}
    This course is generously supported by the Wu Tsai Institute at Yale University. We thank Ping Luo, John Lafferty, Linjun Zhang, Anurag Kashyap, Theo Saarinen, and Yuxuan Zhu for helpful comments and suggestions. 
