...
With Adam, per-GPU memory can be \textbf{4-6x} the model size.
...
3 & + Parameters & about 4-8x \\ \hline
\end{tabular}

\subsubsection{Illustration (conceptual)}
\begin{verbatim}
Naive DP (replicated):   [full][full][full]
ZeRO-1 (opt sharded):    [P,G, O1][P,G, O2][P,G, O3]
ZeRO-2 (opt+grad shard): [P, G1,O1][P, G2,O2][P, G3,O3]
ZeRO-3 (all sharded):    [P1,G1,O1][P2,G2,O2][P3,G3,O3]
